const ProfileSidebar = ({ user, activeTab, onTabChange, onLogout }) => {
  return (
    <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
      ...
      <div className="p-6 text-center relative" style={{ background: 'linear-gradient(135deg, #816047 0%, #6d4a35 100%)' }}>
        <div className="w-20 h-20 rounded-full mx-auto mb-3 ring-4 ring-white/30 flex items-center justify-center text-2xl font-bold text-white" style={{ background: 'linear-gradient(135deg, #D7B790 0%, #9ec4db 100%)' }}>
      ...
      <div className="space-y-2">
        <button
          ...
          style={activeTab === 'profile' ? { backgroundColor: '#816047' } : { color: '#2F1A0F' }}
        >
        ...
        <button
          ...
          style={activeTab === 'addresses' ? { backgroundColor: '#816047' } : { color: '#2F1A0F' }}
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <button
          ...
          style={activeTab === 'orders' ? { backgroundColor: '#816047' } : { color: '#2F1A0F' }}
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
