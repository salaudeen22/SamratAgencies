        ...
        <div className="space-y-6 text-gray-700">
          <section>
            ...
            <div className="mb-4">
              ...
              <ul className="list-disc list-inside ml-4 space-y-2">
                ...
                <li>Cancellation requests must include your order number and registered contact details</li>
            ...
            <div className="mb-4">
              ...
              <ul className="list-disc list-inside ml-4 space-y-2">
                ...
                <li>Cancellation charges (if applicable) will be deducted from the refund amount</li>
              </ul>
            </div>
          ...
          <section>
            ...
            <div className="mb-4">
              ...
              <ul className="list-disc list-inside ml-4 space-y-2">
                ...
                <li><strong>Defective Products:</strong> Product has manufacturing defects</li>
                <li><strong>Wrong Product:</strong> Different product delivered than what was ordered</li>
                <li><strong>Missing Parts:</strong> Product delivered with missing components or accessories</li>
              </ul>
            </div>
            ...
            <div className="mb-4">
              ...
              <ul className="list-disc list-inside ml-4 space-y-2">
                ...
                <li>For damaged/defective products, report within 24 hours of delivery for faster processing</li>
              </ul>
            </div>
            ...
            <div className="mb-4">
              ...
              <ul className="list-disc list-inside ml-4 space-y-2">
                ...
                <li>Products with tampered seals or tags</li>
                <li>Products that have been used, assembled, or installed (unless defective)</li>
            ...
            <div className="mb-4">
              ...
              <ol className="list-decimal list-inside ml-4 space-y-2">
                ...
                <li>Schedule a pickup with our logistics team</li>
                <li>Product will be inspected upon pickup</li>
                <li>Refund or replacement will be processed after verification</li>
              </ol>
            </div>
            ...
            <div className="mb-4">
              ...
              <ul className="list-disc list-inside ml-4 space-y-2">
                ...
                <li>Product must be returned in original packaging with all accessories and documentation</li>
              </ul>
            </div>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside ml-4 space-y-2">
              ...
              <li>Exchange request must be raised within 7 days of delivery</li>
              <li>Exchanges are subject to product availability</li>
              <li>If exact product is not available, we will offer an alternative or refund</li>
              <li>No additional charges for exchanges due to our error</li>
              <li>For voluntary exchanges (change of mind), additional charges may apply</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <div className="mb-4">
              ...
              <ul className="list-disc list-inside ml-4 space-y-2">
                ...
                <li>For Cash on Delivery: Refund will be processed via bank transfer (bank details required)</li>
                <li>It may take 7-10 business days for the refund to reflect in your account (depending on your bank)</li>
              </ul>
            </div>
            ...
            <div className="mb-4">
              ...
              <ul className="list-disc list-inside ml-4 space-y-2">
                ...
                <li>For order cancellations after shipment: Refund minus applicable cancellation and shipping charges</li>
                <li>For voluntary returns: Refund minus return shipping and restocking charges (if applicable)</li>
              </ul>
            </div>
            ...
            <div className="mb-4">
              ...
              <ul className="list-disc list-inside ml-4 space-y-2">
                ...
                <li>Product is returned without original packaging or accessories</li>
                <li>Product is damaged due to customer negligence</li>
              </ul>
            </div>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside ml-4 space-y-2">
              ...
              <li><strong>Furniture Products:</strong> Manufacturing defects covered as per warranty terms (if applicable)</li>
              <li>Warranty does not cover damage due to misuse, accidents, or normal wear and tear</li>
              <li>Warranty claims must be accompanied by original invoice and warranty card</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ol className="list-decimal list-inside ml-4 space-y-2">
              ...
              <li>Submit photos of the product and any damage (if applicable)</li>
              <li>Our customer service team will review and respond within 24-48 hours</li>
              <li>If approved, we will arrange for product pickup</li>
              <li>Keep the product in original condition with all packaging until pickup</li>
            </ol>
          </section>
