  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-white py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-3xl font-bold text-indigo-900 mb-8">Our Products</h1>

        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          {/* Filters Sidebar */}
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-md p-6 sticky top-20 border border-orange-100">
              <h2 className="text-xl font-semibold mb-4 text-indigo-900">Filters</h2>
              ...
              <button
                ...
                className="w-full bg-amber-100 text-orange-700 px-4 py-2 rounded-md hover:bg-amber-200 transition font-medium"
              >
                Clear Filters
              </button>
            </div>
