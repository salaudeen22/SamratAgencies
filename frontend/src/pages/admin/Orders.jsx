    ...
    const invoiceHTML = `
      ...
      <head>
        ...
        <style>
          ...
          .header { text-align: center; margin-bottom: 30px; border-bottom: 2px solid #895F42; padding-bottom: 20px; }
          .company-name { font-size: 28px; font-weight: bold; color: #895F42; margin-bottom: 5px; }
          ...
          .grand-total { font-size: 18px; color: #895F42; border-top: 2px solid #895F42; padding-top: 10px; margin-top: 10px; }
